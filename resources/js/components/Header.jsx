...
function Header() {
    ...
    return (
        <header className="w-full">
            ...
            <div
                className={`bg-red-600 text-white text-center py-2 px-4 text-sm transition-all duration-300 ${isScrolled ? 'h-0 py-0 opacity-0 overflow-hidden' : 'h-auto opacity-100'
                    }`}
            >
            ...
            <div
                className={`transition-all duration-300 ${isScrolled ? 'fixed top-0 left-0 right-0 z-50 shadow-md' : 'relative'
                    }`}
            >
                {/* Main Header */}
            ...
            {isScrolled && <div className="h-[140px]"></div>}
        </header>
    );
}
